...
for_pesce:
    movaps  xmm0,   [ebx+esi] ; [deltaf_i, deltaf_i+1, deltaf_i+2, deltaf_i+3]
    divps   xmm0,   xmm7      ; deltaf_[i  ,..,i+3]/min_deltaf
    addps   xmm0,   [eax+esi] ; [wi, wi+1, wi+2, wi+3]  + [deltaf_i, deltaf_i+1, deltaf_i+2, deltaf_i+3]/min_delta_f
    movaps  [eax+esi],   xmm0
